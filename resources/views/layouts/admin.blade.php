...
<head>
    ...
    <title>Forte | Admin Dashboard</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/admin" class="logo">
            ...
            <span class="logo-mini"><b>FORTE</b> | Admin</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>FORTE</b> | Admin</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="#">&copy; Forte</a></li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/admin_freelancers"><i class="fa fa-dashboard"></i> <span>Add Freelancers</span></a></li>
                <li><a href="/admin_graders"><i class="fa fa-dashboard"></i> <span>Add Graders</span></a></li>
                <li class="header">ACCOUNT INFORMATION</li>
                <li><a href="/secretary"><i class="fa fa-bank"></i> <span>My Account</span></a></li>
                <li><a href="/client/paid_projects"><i class="fa fa-money"></i> <span>Paid Projects</span></a></li>
                <li class="header">PROFILE INFORMATION</li>
                <li><a href="/client/profile"><i class="fa fa-user-o"></i> <span>Update Profile</span></a></li>
