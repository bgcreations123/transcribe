...
<head>
    ...
    <title>{{ config('app.name') }} | Freelance Dashboard</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/freelance"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                <li class="header">JOBS</li>
                <li><a href="/job/create"><i class="fa fa-list-alt"></i> <span>Post a Job</span></a></li>
                <li><a href="/secretary"><i class="fa fa-list"></i> <span>My Posted Jobs</span></a></li>
