...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu white" data-widget="tree">
                ...
                <li><a href="{{ route('grader_project.unclaim',$job->id) }}"><i class="fa fa-sign-out"></i> <span>Unclaim Project</span></a></li>
    ...
    <div class="container-fluid mt-3">
        {!! Form::open(['action' => ['GraderController@update', $job->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        {{ method_field('PATCH') }}
                <textarea name="body" id="article-ckeditor" cols="30" rows="10">{!!$job['body']!!}</textarea>
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                    <textarea name="comments" id="article-ckeditor" value="{{old('comments')}}" placeholder="Any comments regarding the project or the freelancer?" cols="90" rows="10">{!!$job['comments']!!}</textarea>
                    </div>
                    <div class="col-md-4">
                        <label for="formatting">Formatting / 5</label>
                        <input class="form-control" type="number" name="formatting" value="{{old('formatting')}}" placeholder="Formatting">
                        <br>
                        <label for="formatting">Accuracy / 5</label>
                        <input class="form-control" type="number" name="accuracy" value="{{old('accuracy')}}" placeholder="Accuracy">
                    </div>
                </div>
