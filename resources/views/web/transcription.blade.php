...
@section('content')
    <div class="container-fluid mt-3">
        <h1 class="text-center title blue">Audio Transcription Made Simple</h1>
    </div>
    <div class="container">
           <div class="row text-center">
               ...
               <div class="col-md-4">
                    <h3 class="mt-3 mb-3 purple">12 hour</h3>
                    <p class="blue">TURNAROUND TIME</p>
                </div>
                <div class="col-md-4">
                    <h3 class="mt-3 mb-3 blue">99%</h3>
                    <p class="green">ACCURACY</p>
                </div>
           </div>
           <hr>
           <div class="container mt-4">
                <h2 class="title text-center blue">How It Works</h2>
                <div class="row text-center">
                    <div class="col-md-4">
                        <i class="fas fa-sync fa-spin fa-3x green mt-3 mb-3"></i>
                        <h3>Upload English Audio/Video Files</h3>
                        <p>
                    ...
                    <div class="col-md-4">
                        ...
                        <h3>{{ config('app.name') }} Professionals Go to Work</h3>
                        <p>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-6">We offer quick turnaround on transcripts any day of the week.</h1>
